This implementation guide is currently a repository for US Public Health profiles. At this stage the profiles are available to copy but are not available for re-use.
