...
* extension contains
    ...
    USPublicHealthDataEncryptedExtension named contentEncrypted 0..1 MS and
...
// * action.trigger.extension[namedEventType] from USPublicHealthValueSetTriggerDefinitionNamedEvent (extensible)
