It is based on the [CRMI Shareable Library]({{site.data.fhir.ver.hl7fhiruvcrmi}}/StructureDefinition-crmi-shareablelibrary.html) profile and futher constrains it as follows:
